...
struct GroupsView: View {
    ...
    /// Returns favorite groups filtered by search text
    /// Shows all favorites when search is empty
    ...
    /// Returns recent groups filtered by search text
    /// Shows recent groups when search is empty
...
struct NewGroupView: View {
    ...
    /// Creates a new group with selected properties and dismisses view
    /// Saves group to database with all selected members and settings
