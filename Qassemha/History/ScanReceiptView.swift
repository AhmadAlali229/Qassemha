...
struct ScanReceiptView: View {
    ...
    /// Loads and filters recent receipts for current user
    /// Shows only user's own receipts and example receipts
    ...
    /// Requests camera permission and handles authorization states
    /// Shows alert if permission is denied to guide user to settings
