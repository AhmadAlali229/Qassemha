...
struct AllBillSplitsView: View {
    ...
    /// Filters splits based on search text
    /// Returns all splits if search is empty
    ...
    /// Loads all bill splits for current user from database
    /// Filters by user and sorts by most recently updated
